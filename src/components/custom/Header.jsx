  ...
  return (
    <div className="p-3 flex justify-between items-center h-20">
      ...
      <div>
        {user ? (
          <div className="flex items-center gap-4">
            {/* add more trip */}
            <a href="/create-trip">
              <Button variant="outline" className="hidden sm:flex items-center gap-2 rounded-full transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
                ➕ Create Trip
              </Button>
            </a>
            ...
            <Popover>
              <PopoverTrigger>
                <img
                  src={user?.picture}
                className="h-10 w-10 rounded-full cursor-pointer transition-all duration-300 hover:ring-2 hover:scale-110 ring-[#fffafa]"
      ...
      /> */}
          ...
          <Button variant="outline" className="hidden sm:flex items-center gap-2 rounded-full transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg" onClick={() => setopenDialog(true)}>Sign In</Button>
        )}
      </div>
      {/* dialog box */}
